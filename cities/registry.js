...
const OVERRIDES = {
  ...
  VRN:  { orsCountry: 'boundary.country=IN' }, // Varanasi (Inde)
  ...
  CON:  { orsCountry: 'boundary.country=FR' }, // Contis (Landes, France)
  KLN:  { orsCountry: 'boundary.country=DE' }, // Cologne
  HALM: { orsCountry: 'boundary.country=SE' }, // Halmstad
  LCT:  { orsCountry: 'boundary.country=FR' }, // La Ciotat (France)
